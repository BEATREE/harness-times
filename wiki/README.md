...
这个站的正文有 22 章、约 6.4 万汉字、28 张手绘图解、24 段代码、72 道面试问答。
内容分散在四类文件里：
...
| `node scripts/verify-build.mjs` | 产物结构：**120 项**断言（代码块、大翻页区、正文与工具栏同宽、图解动效、侧栏悬停唤出、名词卡片的双语原名 / 命名辨析 / 掌握按钮、中文标点不许吃掉加粗…） | 每次构建后 |
